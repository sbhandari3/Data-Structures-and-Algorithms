...
int main(int argc, char* argv[]){
   ...
   // Test DeleteFixUp
   DeleteFixUp(A,A->root);
   DeleteFixUp(B,B->root);
  
   //Test InsertFixUp
   InsertFixUp(A,A->root);
   InsertFixUp(B,B->root);
   
   // Test Transplant
   Transplant(A, A->root, A->root->left);
   Transplant(B, B->root, B->root->left);
   
   // Test RightRotate
   RotateRight(A, A->root->right)
   RotateRight(B, B->root->left);
   ...
   // Test LeftRotate
   RotateLeft(A, A->root->right)
   RotateLeft(B, B->root->left);

   //Test treemin
   treeMin(A->root);
   treeMax(A->root);
   
   treeSuccessor(A->root);
   treePred(B->root);
